...
export default function Header({
  ...
  const navLinks = [
    ...
    { href: "#project",   click: scrollToProjectSection, label: "Featured Works", icon: "bx bx-briefcase-alt-2" },
    ...
    { href: "#portfolio", click: scrollToServiceSection, label: "Portfolio",     icon: "bx bx-book-content" },
  ...
  return (
    <header className="sidebar">
      <div className="profile">
        ...
        <h1>
          <Link to="/" onClick={handleNavClick}>Fiker Habtamu</Link>
        </h1>
      </div>
