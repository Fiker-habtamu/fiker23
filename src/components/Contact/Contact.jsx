...
export default function Contact({ targetContactSectionRef }) {
  ...
  return (
    ...
    >
      ...
      <div className={`cnt-grid-container ${isIntersecting ? "cnt-visible" : ""}`}>
        
        {/* LEFT COLUMN: TEXT & SOCIAL LINKS */}
        <div className="cnt-left-pane">
          <div className="cnt-badge">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#149ddd" strokeWidth="2.5"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
            <span>Contact</span>
          </div>
          
          <h2 className="cnt-title">Get in touch</h2>
          <p className="cnt-subtitle">
            Have questions or ready to transform your ideas into production-ready software? Let's connect.
          </p>
          ...
          <div className="cnt-info-stack">
            ...
            <a href="danathabtamu@gmail.com" className="cnt-info-card">
              ...
              <div className="cnt-card-arrow">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.6)" strokeWidth="2"><line x1="7" y1="17" x2="17" y2="7"/><polyline points="7,7 17,7 17,17"/></svg>
              </div>
            </a>
            ...
            {/* GitHub Card */}
            <a href="https://github.com/Fiker-habtamu" target="_blank" rel="noopener noreferrer" className="cnt-info-card">
              <div className="cnt-card-icon-box">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"/></svg>
              </div>
              <div className="cnt-card-details">
            ...
            {/* LinkedIn Card */}
            <a href="https://www.linkedin.com/in/fiker-habtamu/" target="_blank" rel="noopener noreferrer" className="cnt-info-card">
              <div className="cnt-card-icon-box">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg>
              </div>
              <div className="cnt-card-details">
                <span className="cnt-card-label">LinkedIn</span>
                <span className="cnt-card-value">linkedin.com/in/fiker-habtamu</span>
              </div>
              <div className="cnt-card-arrow">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.6)" strokeWidth="2"><line x1="7" y1="17" x2="17" y2="7"/><polyline points="7,7 17,7 17,17"/></svg>
              </div>
        ...
        <div className="cnt-right-pane">
          <form onSubmit={handleSubmit} className="cnt-form-box">
            <div className="cnt-input-group">
              <input type="text" id="name" required placeholder=" " className="cnt-form-input" />
              <label htmlFor="name" className="cnt-form-label">Name</label>
            </div>

            <div className="cnt-input-group">
              <input type="email" id="email" required placeholder=" " className="cnt-form-input" />
              <label htmlFor="email" className="cnt-form-label">Email</label>
            </div>

            <div className="cnt-input-group">
              <textarea id="message" required rows="6" placeholder=" " className="cnt-form-input cnt-form-textarea"></textarea>
